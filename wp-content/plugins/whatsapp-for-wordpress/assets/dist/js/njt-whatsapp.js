    ...
    n.n = t => {
        ...
        window.njtWhatsApp = {
            ...
            createWidget: function(t, e) {
                ...
                a.setAttribute("class", "wa__btn_popup"), a.onclick = function(t) {
                    ...
                    r.classList.contains("wa__active") ? (r.classList.remove("wa__active"), a.classList.remove("wa__active"), clearTimeout(i), r.classList.contains("wa__lauch") && (s = setTimeout((function() {
                        r.classList.remove("wa__pending"), r.classList.remove("wa__lauch")
                    }), 400))) : (r.classList.add("wa__pending"), r.classList.add("wa__active"), a.classList.add("wa__active"), clearTimeout(s), r.classList.contains("wa__lauch") || (i = setTimeout((function() {
